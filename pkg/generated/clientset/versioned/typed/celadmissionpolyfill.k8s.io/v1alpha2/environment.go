...
type EnvironmentInterface interface {
	Create(ctx context.Context, environment *v1alpha2.Environment, opts v1.CreateOptions) (*v1alpha2.Environment, error)
	Update(ctx context.Context, environment *v1alpha2.Environment, opts v1.UpdateOptions) (*v1alpha2.Environment, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha2.Environment, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha2.EnvironmentList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.Environment, err error)
...
func newEnvironments(c *CeladmissionpolyfillV1alpha2Client, namespace string) *environments {
	return &environments{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *environments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.Environment, err error) {
	result = &v1alpha2.Environment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *environments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.EnvironmentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha2.EnvironmentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("environments").
...
func (c *environments) Create(ctx context.Context, environment *v1alpha2.Environment, opts v1.CreateOptions) (result *v1alpha2.Environment, err error) {
	result = &v1alpha2.Environment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("environments").
...
func (c *environments) Update(ctx context.Context, environment *v1alpha2.Environment, opts v1.UpdateOptions) (result *v1alpha2.Environment, err error) {
	result = &v1alpha2.Environment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("environments").
...
func (c *environments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.Environment, err error) {
	result = &v1alpha2.Environment{}
